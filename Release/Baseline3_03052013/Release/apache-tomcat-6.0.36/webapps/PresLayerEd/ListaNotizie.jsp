...
<div style="vertical-align: middle" align="center">
	...
	<div><img src="./icon/istruzioni.png" style="margin-left:20px;"/></div>
	<s:form action="viewListaNotizie.action" method="post" validate="true">
		<s:textfield name="testo_ricerca" size="40" />
		<select name="filtroParametro" id="filtroParametroId" style="float:right; margin-left:-250px; margin-right:190px; margin-top:5px; margin-bottom:10px;">  
